...
// ✅ Intermediate Level Words (LONG vowels correct)
const WORDS = [
  { word: "cake", isCorrect: true }, { word: "kite", isCorrect: true },
  { word: "rope", isCorrect: true }, { word: "cube", isCorrect: true },
  ...
  { word: "log", isCorrect: false }, { word: "fin", isCorrect: false },
  { word: "bus", isCorrect: false }, { word: "pen", isCorrect: false },
];
...
export default function IntermediateVowelGame() {
  ...
  const practiceMessage =
    shortWordsCaught > longWordsCaught / 2
      ? "⚠️ Needs more practice with LONG vowels!"
    ...
    >
      ...
      {gameStarted && !isGameOver && (
        <View style={styles.gameHeader}>
          ...
          <Text style={styles.gameHeaderLevel}>INTERMEDIATE LEVEL</Text>
        </View>
      )}
